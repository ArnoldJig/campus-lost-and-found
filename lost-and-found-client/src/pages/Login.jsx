        ...
        <div style={{
          ...
          <FadeIn delay={0.1}>
            <div style={{ textAlign: 'center', marginBottom: '28px' }}>
              ...
              <h2 style={{ fontSize: '22px', fontWeight: '700', color: textColor, marginBottom: '6px' }}>Welcome back</h2>
              <p style={{ fontSize: '13px', color: mutedColor }}>Sign in to your CampusFind account</p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: mutedColor }}>
              ...
              <Link to="/register" style={{ color: '#D4845A', fontWeight: '500' }}>Create one</Link>
            </p>
          </FadeIn>
        </div>
      </SlideIn>
